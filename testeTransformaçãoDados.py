...
def extrair_definicoes_rodape(pdf_path, start_page=2):
    """Extrai as definições de OD e AMB do rodapé a partir da terceira página."""
    definicoes = {}
    with pdfplumber.open(pdf_path) as pdf:
...
caminho_pdf = r"anexos\Anexo_I_Rol_2021RN_465.2021_RN627L.2024.pdf"
diretorio_atual = Path(__file__).parent
caminho_csv = diretorio_atual / "Teste_Michael.csv"
caminho_zip = "Teste_Michael.zip"
